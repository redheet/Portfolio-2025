...
export default function About({
  ...
  const structure = [
    ...
    },
    {
      ...
      display: about.developer.display,
      items: [],
    },
    {
    ...
    <Flex fillWidth maxWidth="m" direction="column">
      ...
      <Flex fillWidth mobileDirection="column" justifyContent="center">
        ...
        >
          ...
          {/* dev skills  */}
          {about.developer.display && (
            <>
              <Heading
                as="h2"
                id={about.developer.title}
                variant="display-strong-s"
                marginBottom="m"
              >
              ...
              <Flex direction="column" fillWidth gap="l" marginBottom="40">
                ...
                >
                  <Icon name="js" size="l" />
                  <Icon name="sass" size="l" />
                  <Icon name="nextjs" size="l" />
                  <Icon name="nodejs" size="l" />
                  <Icon name="yarn" size="l" />
                  <Icon name="github" size="l" />
                  <Icon name="cloudflare" size="l" />
                  <Icon name="firebase" size="l" />
                  <Icon name="vercel" size="l" />
                  <Icon name="heroku" size="l" />
                </Flex>
              </Flex>
            </>
          )}
